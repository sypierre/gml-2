function [faces] = create_user_profile(cap, user_name)
    f = figure('Position',[360,500,450,285]);
    hsnap    = uicontrol('Style','pushbutton',...
        'String','Snap picture','Position',[300,220,100,25],...
        'Callback',{@snapbutton_Callback});
    hsnap    = uicontrol('Style','pushbutton',...
        'String','Save picture','Position',[300,180,100,25],...
        'Callback',{@savebutton_Callback});


    EXTR_FRAME_SIZE = 96;
    ha = axes('Units','pixels','Position',[30,60,200,185]);
    ...
    function snapbutton_Callback(source,eventdata) 
